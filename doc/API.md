...
| [options.keychain] | `object` | libp2p Keychain configuration
| [options.keychain.pass] | `string` | libp2p Keychain passphrase
| [options.keychain.datastore] | `object` | must implement [ipfs/interface-datastore](https://github.com/ipfs/interface-datastore) (in memory datastore will be used if not provided) |
